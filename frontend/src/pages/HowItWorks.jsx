  ...
  return (
    <div className="min-h-screen w-full bg-[#0a0f24] text-white flex flex-col items-center px-6 pt-24 pb-16">
      ...
      <div className="max-w-2xl bg-[#11172e] px-8 py-8 rounded-xl text-gray-300 text-lg leading-relaxed shadow-lg">
        CarBidX revolutionizes car buying through reverse auctions. Buyers 
        submit their dream car requirements, and verified dealers compete 
        with offers. Our AI-assisted platform ensures you get the best deal 
        while maintaining complete transparency and security throughout 
        the process.
      </div>
